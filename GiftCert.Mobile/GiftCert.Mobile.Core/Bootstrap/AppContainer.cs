...
using GiftCert.Mobile.Core.Repository;
using GiftCert.Mobile.Core.Services.Data;
using GiftCert.Mobile.Core.Services.General;
using GiftCert.Mobile.Core.ViewModels;

namespace GiftCert.Mobile.Core.Bootstrap
{
